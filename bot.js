...
client.on("guildMemberAdd", member => {
  ...
  .setDescription("\nПриветствую тебя на сервере ZOOPARK!\nЭто официальный дискорд-сервер **Happy Wolf'a**.\n\nПожалуйста, прочти и соблюдай правила, которые ты сможешь найти в <#416832026155548679>, также, советую прочесть канал <#417274723119005697>, в котором собрана вся информация о сервере.\n\nОбязательно проверяй <#401720121498009600>, ведь там ты сможешь найти много чего интерсного.\n\nГлавное будь дружелюбным по отношению к другим участникам, а также соблюдай правила, и тогда никаких проблем не будет. \n\n**Удачи!**")
  .setFooter("ZOOPARK")
  ...
  member.send({embed});
	...
	client.user.setPresence({ game: { name: `ZOOPARK`, type: 2 } }).catch();
});
